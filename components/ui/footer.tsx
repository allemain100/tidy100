...
import LSCLogo from "@/public/images/LSC_Logo_768684858.png";
    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs">
            <div className="mb-2">
              ...
              {/*  </svg>*/}
              {/*</Link>*/}
              <Link href="/" className="block text-blue-600 transition duration-150 ease-in-out" aria-label="LSC">
                <Image className="w-60 h-38 fill-current" src={LSCLogo} alt="LSCLogo" />
            ...
            <div className="text-lg font-bold text-slate-800">Liberty Sailing Club<br />Philadelphia Cup Regatta 2025</div>
          </div>

          {/* 2nd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">&nbsp;</h6>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-slate-500 mr-4">&nbsp;</div>
